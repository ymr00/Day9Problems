...
public class Empwageuc7 {
	...
	public void calculateMonthlyWage() {
		...
		System.out.println("the randomnumber is : " + getRandomNumber());
		System.out.println("the dailywage : " + dailyWage);
		System.out.println("the total working hours : " + totalWorkingHour);
